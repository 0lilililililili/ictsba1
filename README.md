...
## 1.	Relationships
  ...
  However, note that student-club and student-activity result in many-to-many relationships, we need to resolve them into a one-to-many relationship using associative entities to prevent data redundancy. To resolve the student-club table and the student-activity table, they each need one associative entity respectively. Thus, both relationships are now modified as below:
...
## 5.	Authorization
  ...
  Club teachers can only edit their own data, students’ participation status, and data of their clubs and activities.
